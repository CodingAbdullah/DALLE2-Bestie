                ...
                <div className="row">
                    <div className="bg-dark col-sm-12 col-md-12 col-lg-6">
                        <div className='d-flex-col text-white px-3 py-5'>
                                ...
                                <p style={ styles.about_paragraph }>This is a MVP (Minimable Viable Product). More features will be incorporated in the not-so distant future as more API resources become available and the thought process behind incorporating them becomes clear.</p>
